  ...
  return (
    <ScrollView>
      <View style={commonStyles.FlexColStartStart}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('MESSAGE_DETAIL', { recipientDisplayName: "Chef Mariano" })} containerStyle={styles.TouchableOpacityContainer} style={[styles.WhiteBackgroundView]}>
          <View>
            <Image source={Chef2} style={[styles.CardImageStyle]} containerStyle={{ marginLeft: 20 }} />
          </View>
          <View style={{ marginLeft: 10 }}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('MESSAGE_DETAIL', { recipientDisplayName: "Chef Juan Carlo" })} containerStyle={styles.TouchableOpacityContainer} style={[styles.WhiteBackgroundView, commonStyles.mt10]}>
          <View>
            <Image source={Chef3} style={[styles.CardImageStyle]} containerStyle={{ marginLeft: 20 }} />
          </View>
          <View style={{ marginLeft: 10 }}>
