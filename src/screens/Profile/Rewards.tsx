      ...
      >
        ...
        <View style={[styles.howToEarnBlock]}>
          <View style={[styles.howToEarnText]}>
            ...
            <Text style={commonStyles.mx10}>
              1: Order a service from one of our many expeienced chefs for two
              or more guests.
            </Text>
            <Text style={commonStyles.mx10}>
              2: Refer Cookd to a friend or family member and when they use our
              service for the first time you recieve a reward point.
            </Text>
          </View>
        </View>
      </ScrollView>
