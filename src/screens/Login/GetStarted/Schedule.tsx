      ...
      <View style={[styles.SectionStyle]}>
        ...
        <View style={[styles.TextContainer]}>
          ...
          <Text type="description" centerText>
            Pick your time, place, number of guests and any special requests.{' '}
          </Text>
          <Text type="description" centerText style={commonStyles.mt10}>
            Feel free to message the chef before-hand for any questions.
          </Text>
        </View>
        <Button
          onPress={submit}
        ...
        />
        <Text onPress={submit} style={[styles.LinkText]}>
          skip
        </Text>
      </View>
    </View>
