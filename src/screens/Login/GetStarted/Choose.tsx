    ...
    <View style={commonStyles.FlexColCenterCenter}>
      <View style={[styles.SectionStyle]}>
        ...
        <View style={[styles.TextContainer, commonStyles.mb20]}>
          ...
          <Text type="description" style={commonStyles.mb10} centerText>
            After finding a Chef you have two options:
          </Text>
          <Text type="description" centerText>
            1. Choose one of thier signature menu offerings.
          </Text>
          <Text type="description" centerText style={commonStyles.mt10}>
            2. Request your Chef to use your own ingredients.
          </Text>
        </View>
        <Button
          onPress={submit}
