  ...
  return (
    <View style={commonStyles.FlexColCenterCenter}>
      <View style={[styles.SectionStyle]}>
        <Text type="large-header" centerText>Bringing Fine Dining Home in 3 Steps</Text>
        <Image
          source={ChefImage}
        ...
        <View style={[styles.TextContainer, commonStyles.mb20]}>
          <Text type="large-header" centerText>Step 1: Browse</Text>
          <Text style={commonStyles.mt20} type="description" centerText>Browse Certefied Cookd Chefs in your area. </Text>
        </View>
        <Button
          onPress={submit}
          style={styles.Button}
